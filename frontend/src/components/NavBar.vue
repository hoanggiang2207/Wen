<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />Pavillion Hotel
        </router-link>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #FEAFA2;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
